...
import { MainTransaction } from '@/new-domain/transactions/main'
...
export function Home() {
  ...
  const dataHomeTemplate: HomeTemplateUITypes = {
    ...
    sectionCardsTransactions: {
      totalIncomingTransactions: transactions.allData.cards.deposit,
      totalOutgoingTransactions: transactions.allData.cards.withdrawn,
      totalTransactions: transactions.allData.cards.withdrawn
    },
