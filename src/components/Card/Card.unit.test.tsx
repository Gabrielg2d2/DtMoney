...
describe('CardTotal', () => {
  it('should render component CardTotal', () => {
    render(<CardTotal title="Card_Jest_Title" value="R$ 0,00" />)
...
describe('CardIncoming', () => {
  it('should render component CardIncoming', () => {
    render(<CardIncoming title="Card_Jest_Title" value="R$ 0,00" />)
...
describe('CardOutgoing', () => {
  it('should render component CardOutgoing', () => {
    render(<CardOutgoing title="Card_Jest_Title" value="R$ 0,00" />)
